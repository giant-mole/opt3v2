...
public class Boormachine extends Product {
    ...
    public boolean doorlopen() {
        if (verzekeringskosten > 0 && verzekering && verhuurd) {
            System.out.println("uitgeleend");
            return true;
        }
    ...
    public int verhuren() {
        if (aantalDagen <= 0) {
            System.out.println("niet ingeleeverd");
            return 0;
        } else if (aantalDagen > 1 && aantalDagen <= 100) {
            System.out.println("binnenkort inleveren");
            return 1;
        }
        System.out.println("lang uitgeleend");
        return 2;
